...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/laravel-debug.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/laravel-debug)
...
```bash
php artisan vendor:publish --tag="laravel-debug-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="laravel-debug-config"
```
...
```bash
php artisan vendor:publish --tag="laravel-debug-views"
```

## Usage

```php
$laravelDebug = new Furqat\LaravelDebug();
echo $laravelDebug->echoPhrase('Hello, Furqat!');
```
